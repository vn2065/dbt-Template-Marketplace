...
### Twitter/X — SaaS Metrics
```
If you've ever joined a company and rebuilt MRR models from scratch... I made something for you.

A production-ready dbt template with:
✅ MRR waterfall (new/expansion/churn/reactivation)
✅ NRR, GRR, Quick Ratio
✅ Cohort retention
✅ Customer LTV
✅ 100% test coverage
...
### Twitter/X — eCommerce
```
Built an eCommerce analytics dbt template so you never have to rebuild RFM from scratch again.

Includes:
📦 Purchase funnel analysis
👥 7 RFM customer segments (ready to export to your ESP)
📊 Product performance with revenue rank
...
The `monthly_saas_metrics` table gives you every metric your investors will ask about:
✅ MRR / ARR
✅ New Business MRR
✅ Expansion MRR
✅ Churn MRR
...
If you work in analytics engineering, you've probably built some version of these models at least once:
- SaaS MRR waterfall
